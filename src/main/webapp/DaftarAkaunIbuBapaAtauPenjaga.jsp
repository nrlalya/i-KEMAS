<%-- 
    Document   : DaftarAkaunIbuBapaAtauPenjaga.jsp
--%>
...
<html lang="en" class="light">
    <head>
        ...
        <!-- External CSS -->
        <link rel="stylesheet" href="css/DaftarAkaunIbuBapaAtauPenjaga.css">
    </head>
    <body class="bg-background-light dark:bg-background-dark font-display text-[#0d121b] dark:text-white antialiased">

        <%-- Notification bar overlay berdasarkan status daftar --%>
        <%
            ...
            if ("success".equals(status)) {
                ...
                message = "Emel sudah wujud. Sila gunakan emel lain.";
                bgColor = "bg-yellow-500";
            }
        %>

        <% if (!message.isEmpty()) {%>
        <div id="overlayAlert" class="fixed top-0 left-0 w-full z-50 <%= bgColor%> text-white text-center py-4 font-semibold shadow-md transition-all duration-500">
            <%= message%>
        </div>
        <script>
            setTimeout(() => {
            ...
            <% if ("success".equals(status)) { %>
                // Redirect ke page log masuk selepas alert hilang
            ...
            <div class="relative hidden lg:flex w-1/2 flex-col justify-between bg-primary p-12 xl:p-16">
                ...
                <div class="relative z-10 flex items-center gap-3">
                    <div>
                        ...
                        <p class="text-xs text-blue-100 uppercase tracking-widest opacity-80">
                            Sistem Pengurusan Kanak-Kanak Tabika KEMAS
                        </p>
                    </div>
                </div>
            ...
            <div class="flex w-full lg:w-1/2 flex-col justify-center items-center p-6 md:p-12 lg:p-16 relative bg-background-light dark:bg-background-dark">
                <div class="w-full max-w-[440px] flex flex-col gap-8">
                    <div class="flex flex-col gap-2 text-left">
                        <h2 class="text-[32px] font-bold">Daftar Akaun Baru</h2>
                        <p class="text-slate-500 dark:text-slate-400">
                            Sila lengkapkan maklumat di bawah untuk mendaftar akaun anda.
                        </p>
                    </div>

                    <!-- Form daftar -->
                    <form action="${pageContext.request.contextPath}/controller/DaftarAkaunIbuBapaAtauPenjagaServlet" method="post" class="flex flex-col gap-5">
                        ...
                        <div class="grid grid-cols-2 gap-4">
                            ...
                            <label class="flex flex-col">
                                <span class="text-sm font-semibold">Sahkan Kata Laluan</span>
