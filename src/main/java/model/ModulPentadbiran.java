/* 
    Document   : ModulPentadbiran.java
 */
...
public class ModulPentadbiran {

    private int idModulPentadbiran;   
    ...
    public int getIdModulPentadbiran() {
        return idModulPentadbiran;
    }

    public void setIdModulPentadbiran(int idModulPentadbiran) {
