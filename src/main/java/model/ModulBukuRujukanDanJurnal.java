/* 
    Document   : ModulBukuRujukanDanJurnal.java
 */
...
public class ModulBukuRujukanDanJurnal {

    private int idBukuRujukanDanJurnal;  
    ...
    public int getIdBukuRujukanDanJurnal() {
        return idBukuRujukanDanJurnal;
    }

    public void setIdBukuRujukanDanJurnal(int idBukuRujukanDanJurnal) {
